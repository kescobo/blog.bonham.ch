/*!
  Highlight.js v11.3.1 (git: 85ac872874)
...
const E="[a-zA-Z]\\w*",N="[a-zA-Z_]\\w*",y="\\b\\d+(\\.\\d+)?",w="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",v="\\b(0b[01]+)",x={
begin:"\\\\[\\s\\S]",relevance:0},O={scope:"string",begin:"'",end:"'",
illegal:"\\n",contains:[x]},M={scope:"string",begin:'"',end:'"',illegal:"\\n",
contains:[x]},S=(e,n,t={})=>{const a=r({scope:"comment",begin:e,end:n,
contains:[]},t);a.contains.push({scope:"doctag",
begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",
end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0})
;const i=p("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/)
;return a.contains.push({begin:m(/[ ]+/,"(",i,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),a
},k=S("//","$"),A=S("/\\*","\\*/"),C=S("#","$");var T=Object.freeze({
__proto__:null,MATCH_NOTHING_RE:/\b\B/,IDENT_RE:E,UNDERSCORE_IDENT_RE:N,
...
},COMMENT:S,C_LINE_COMMENT_MODE:k,C_BLOCK_COMMENT_MODE:A,HASH_COMMENT_MODE:C,
...
return n?Number(n):(e=>U.includes(e.toLowerCase()))(e)?0:1}const P={},K=e=>{
...
Z;G(e,e.end,{key:"endScope"}),e.end=f(e.end,{joinWith:""})}})(e)}function V(e){
function n(n,t){
...
;[I,B,W,F].forEach((e=>e(i,s))),e.compilerExtensions.forEach((e=>e(i,s))),
i.__beforeBegin=null,[D,L,$].forEach((e=>e(i,s))),i.isCompiled=!0;let l=null
...
variants:null},n)))),e.cachedVariants?e.cachedVariants:Q(e)?r(e,{
...
const l=Object.create(null);function c(){if(!O.keywords)return void S.addText(k)
;let e=0;O.keywordPatternRe.lastIndex=0;let n=O.keywordPatternRe.exec(k),t=""
;for(;n;){t+=k.substring(e,n.index)
;const i=y.case_insensitive?n[0].toLowerCase():n[0],r=(a=i,O.keywords[a]);if(r){
const[e,a]=r
;if(S.addText(t),t="",l[i]=(l[i]||0)+1,l[i]<=7&&(A+=a),e.startsWith("_"))t+=n[0];else{
const t=y.classNameAliases[e]||e;S.addKeyword(n[0],t)}}else t+=n[0]
;e=O.keywordPatternRe.lastIndex,n=O.keywordPatternRe.exec(k)}var a
;t+=k.substr(e),S.addText(t)}function g(){null!=O.subLanguage?(()=>{
if(""===k)return;let e=null;if("string"==typeof O.subLanguage){
if(!n[O.subLanguage])return void S.addText(k)
;e=f(O.subLanguage,k,!0,M[O.subLanguage]),M[O.subLanguage]=e._top
}else e=E(k,O.subLanguage.length?O.subLanguage:null)
;O.relevance>0&&(A+=e.relevance),S.addSublanguage(e._emitter,e.language)
})():c(),k=""}function u(e,n){let t=1;for(;void 0!==n[t];){if(!e._emit[t]){t++
;continue}const a=y.classNameAliases[e[t]]||e[t],i=n[t]
;a?S.addKeyword(i,a):(k=i,c(),k=""),t++}}function b(e,n){
...
return 0===O.matcher.regexIndex?(k+=e[0],1):(R=!0,0)}function _(e){
const n=e[0],a=t.substr(e.index),i=m(O,e,a);if(!i)return ee;const r=O
;O.endScope&&O.endScope._wrap?(g(),
S.addKeyword(n,O.endScope._wrap)):O.endScope&&O.endScope._multi?(g(),
u(O.endScope,e)):r.skip?k+=n:(r.returnEnd||r.excludeEnd||(k+=n),
g(),r.excludeEnd&&(k=n));do{
O.scope&&S.closeNode(),O.skip||O.subLanguage||(A+=O.relevance),O=O.parent
}while(O!==i.parent);return i.starts&&b(i.starts,e),r.returnEnd?0:n.length}
let h={};function N(n,r){const o=r&&r[0];if(k+=n,null==o)return g(),0
...
g(),t.returnBegin||t.excludeBegin||(k=n)),b(t,e),t.returnBegin?0:n.length})(r)
;if("illegal"===r.type&&!i){
...
;return k+=o,o.length}const y=v(e)
;if(!y)throw K(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const w=V(y);let x="",O=r||w;const M={},S=new d.__emitter(d);(()=>{const e=[]
...
;const e=O.matcher.exec(t);if(!e)break;const n=N(t.substring(C,e.index),e)
;C=e.index+n}return N(t.substr(C)),S.closeAllNodes(),S.finalize(),x=S.toHTML(),{
language:e,value:x,relevance:A,illegal:!1,_emitter:S,_top:O}}catch(n){
if(n.message&&n.message.includes("Illegal"))return{language:e,value:J(t),
illegal:!0,relevance:0,_illegalBy:{message:n.message,index:C,
context:t.slice(C-100,C+100),mode:n.mode,resultSoFar:x},_emitter:S};if(s)return{
...
}),M("after:highlightElement",{el:e,result:r,text:a})}let y=!1;function w(){
...
y&&w()}),!1),Object.assign(e,{highlight:h,highlightAuto:E,highlightAll:w,
highlightElement:N,
highlightBlock:e=>(q("10.7.0","highlightBlock will be removed entirely in v12.0"),
q("10.7.0","Please use highlightElement now."),N(e)),configure:e=>{d=Y(d,e)},
initHighlighting:()=>{
...
}},i={$pattern:be,keyword:me,literal:pe,built_in:Ne,"variable.language":Ee
...
illegal:/%/},N={
match:n.concat(/\b/,(y=[...fe,"super"],n.concat("(?!",y.join("|"),")")),t,n.lookahead(/\(/)),
className:"title.function",relevance:0};var y;const w={
...
const we=e=>m(/\b/,e,/\w$/.test(e)?/\b/:/\B/),ve=["Protocol","Type"].map(we),xe=["init","self"].map(we),Oe=["Any","Self"],Me=["actor","associatedtype","async","await",/as\?/,/as!/,"as","break","case","catch","class","continue","convenience","default","defer","deinit","didSet","do","dynamic","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],Se=["false","nil","true"],ke=["assignment","associativity","higherThan","left","lowerThan","none","right"],Ae=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warn_unqualified_access","#warning"],Ce=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],Te=p(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),Re=p(Te,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),Ie=m(Te,Re,"*"),De=p(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),Le=p(De,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),Be=m(De,Le,"*"),$e=m(/[A-Z]/,Le,"*"),Fe=["autoclosure",m(/convention\(/,p("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",m(/objc\(/,Be,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","testable","UIApplicationMain","unknown","usableFromInline"],Ue=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"]
;var ze=Object.freeze({__proto__:null,grmr_bash:e=>{const n=e.regex,t={},a={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ge,i]}},grmr_javascript:ye,
...
relevance:0},l,b,e.HASH_COMMENT_MODE,{match:[/def/,/\s+/,t],scope:{1:"keyword",
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,p(...ve,...xe)],
className:{2:"keyword"}},r={match:m(/\./,p(...Me)),relevance:0
},s=Me.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:p(...Me.filter((e=>"string"!=typeof e)).concat(Oe).map(we),...xe)}]},l={
$pattern:p(/\b\w+/,/#\w+/),keyword:s.concat(Ae),literal:Se},c=[i,r,o],d=[{
match:m(/\./,p(...Ce)),relevance:0},{className:"built_in",
match:m(/\b/,p(...Ce),/(?=\()/)}],u={match:/->/,relevance:0},b=[u,{
className:"operator",relevance:0,variants:[{match:Ie},{match:`\\.(\\.|${Re})+`}]
...
match:m(/\\/,e,/[\t ]*(?:[\r\n]|\r\n)/)}),N=(e="")=>({className:"subst",
label:"interpol",begin:m(/\\/,e,/\(/),end:/\)/}),y=(e="")=>({begin:m(e,/"""/),
end:m(/"""/,e),contains:[f(e),E(e),N(e)]}),w=(e="")=>({begin:m(e,/"/),
end:m(/"/,e),contains:[f(e),N(e)]}),v={className:"string",
variants:[y(),y("#"),y("##"),y("###"),w(),w("#"),w("##"),w("###")]},x={
match:m(/`/,Be,/`/)},O=[x,{className:"variable",match:/\$\d+/},{
...
className:"meta",match:m(/@/,Be)}],S={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
match:m(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Le,"+")
},{className:"type",match:$e,relevance:0},{match:/[?!]+/,relevance:0},{
match:/\.\.\./,relevance:0},{match:m(/\s+&\s+/,g($e)),relevance:0}]},k={
begin:/</,end:/>/,keywords:l,contains:[...a,...c,...M,u,S]};S.contains.push(k)
;const A={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",{
match:m(Be,/\s*:/),keywords:"_|0",relevance:0
},...a,...c,...d,...b,h,v,...O,...M,S]},C={begin:/</,end:/>/,contains:[...a,S]
},T={begin:/\(/,end:/\)/,keywords:l,contains:[{
begin:p(g(m(Be,/\s*:/)),g(m(Be,/\s+/,Be,/\s*:/))),end:/:/,relevance:0,
contains:[{className:"keyword",match:/\b_\b/},{className:"params",match:Be}]
},...a,...c,...b,h,v,...M,S,A],endsParent:!0,illegal:/["']/},R={
match:[/func/,/\s+/,p(x.match,Be,Ie)],className:{1:"keyword",3:"title.function"
},contains:[C,T,n],illegal:[/\[/,/%/]},I={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},
contains:[C,T,n],illegal:/\[|%/},D={match:[/operator/,/\s+/,Ie],className:{
1:"keyword",3:"title"}},L={begin:[/precedencegroup/,/\s+/,$e],className:{
1:"keyword",3:"title"},contains:[S],keywords:[...ke,...Se],end:/}/}
...
},...c,...d,...b,h,v,...O,...M,S,A]}},grmr_typescript:e=>{
const n=ye(e),t=["any","void","number","boolean","string","object","never","enum"],a={
...
literal:pe,built_in:Ne.concat(t),"variable.language":Ee},s={className:"meta",
...
aliases:["yml"],contains:l}},grmr_julia:e=>{
...
},a={keywords:t,illegal:/<\//},i={className:"keyword",begin:"&&|\\|\\||="},r={
...
begin:"(?<=where\\s+)"+n}],contains:[s,r,i,{begin:n,className:"type"}]},l={
